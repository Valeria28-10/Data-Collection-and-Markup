...
client_secret = "__"
city = "Baranovichi"
valid_categories = ['coffee shop', 'museum', 'park', 'zoo', 'cafe', 'shop', 'restaurant', 'restauran']

url = "https://api.foursquare.com/v3/places/search"

category = input("Enter a category from coffee shop, museum, park, zoo, cafe, shop, restaurant or restauran: ")

while category == "" or category.lower() not in valid_categories:
    print("Input cannot be empty, enter a category: coffee shop, museum, park, zoo, cafe, shop, restaurant, restauran")
    category = input("Enter a category from coffee shop, museum, park, zoo, cafe, shop, restaurant or restauran: ").strip()
